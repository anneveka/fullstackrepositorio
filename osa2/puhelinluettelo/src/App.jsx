...
const App = () => {
    ...
    const addNameAndNumber = (event) => {
        ...
        if (
            ...
            //tarkistetaan onko numeroa tai nimeä jo kirjoilla
    ...
    const filteredPersons = persons.filter(
        (person) => person.name.toLowerCase().includes(search.toLowerCase()), //filteröidään hakuun sopivat nimet
    );
...
const Notification = ({ message }) => {
    ...
    return <div className="ilmoitus">{message}</div>;
};
